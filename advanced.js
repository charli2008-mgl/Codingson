...
const levels = [
  {
    ...
    lesson:
      "<p><code>h1</code> зэрэг тагууд бүх гарчгийг өөрчилдөг. Харин <b>class</b> ашиглан тодорхой элементүүдийг өөрчилж болно.</p><p>1. div дээр <code>class='box'</code> нэм.<br>2. CSS дээр <code>.box</code> ашиглан style хийнэ.</p>",
    task: "div дээр 'box class өгөөд арын өнгийг цэнхэр болго.",
    html: "<div>I am a box</div>",
    css: "/* .box классыг энд style хийнэ */\n",
    check: (h, c) =>
      h.includes('class=\"box\"') && c.includes(".box") && c.includes("blue"),
  },
  {
    title: "Түвшин 2: Input талбар",
    lesson:
      "<p>Вэб сайт хэрэглэгчээс мэдээлэл авах хэрэгтэй. <code>&lt;input&gt;</code> таг ашиглана.</p><p>Атрибутууд: <code>type='text'</code>, <code>placeholder='Name...'</code></p>",
  ...
  },
  {
    ...
    lesson:
      "<p>Орчин үеийн товчнууд булан нь дугуй байдаг. Үүнийг <code>border-radius</code>-аар хийдэг.</p>",
  ...
  },
  {
    ...
    lesson:
      "<p><b>Flexbox</b> нь layout хийх хамгийн сайн арга. Элементүүдийг зэрэгцүүлж байрлуулна.</p><p><code>display: flex;</code> нэмээд турш.</p>",
  ...
  },
  {
    ...
    lesson:
      "<p>Flexbox ашиглах үед <code>justify-content</code> нь хэвтээ тэнхлэгт байрлалыг тохируулна.</p>",
  ...
  },
  {
    ...
    lesson:
      "<p>Flexbox анхнаасаа row (хэвтээ) байдаг. <code>flex-direction: column;</code> ашиглан босоо болгоно.</p>",
  ...
  },
  {
    ...
    lesson:
      "<p><b>Padding</b> нь дотор зай.<br><b>Margin</b> нь гадна зай.</p>",
    task: "button дээр 20px padding болон 20px margin нэм.",
    html: "<button>Space Me</button>",
    css: "button {\n  background: pink;\n  border: 1px solid red;\n}",
    check: (h, c) =>
      c.includes("padding") && c.includes("margin") && c.includes("20px"),
  },
];
